...
////// Emissive:
                ...
                float3 emissive = (((((1.0-max(0,dot(normalDirection, viewDirection)))*0.4)*float3(0.9926471,0.7792178,0.2189662)*3.0)*2.0*((1.0-max(0,dot(normalDirection, viewDirection)))*0.5*float3(1,0.8068966,0)))*_node_222_var.rgb*i.vertexColor.rgb);
